...
import { LayoutDashboard, CheckSquare, Calendar, BarChart2, Trophy, Gift, BookOpen, Sparkles, Settings, Menu, X } from 'lucide-react'
  ...
  return (
    <>
      ...
      <button
        ...
        className="md:hidden fixed top-4 left-4 z-50 bg-gray-900 border border-gray-800 p-2 rounded-lg text-gray-400 hover:text-white"
      >
        <Menu size={22} />
      </button>
      ...
      <aside className={`md:hidden fixed top-0 left-0 h-full w-64 bg-gray-900 border-r border-gray-800 flex flex-col p-4 z-50 transition-transform duration-300 ${open ? 'translate-x-0' : '-translate-x-full'}`}>
